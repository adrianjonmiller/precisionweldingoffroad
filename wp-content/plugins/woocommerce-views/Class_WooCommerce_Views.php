...
?>	
	...
	<div class="wrap">
		...
		<form id="woocommerce_views_form" action="" method="post">
...
**/
function add_to_cart_buy_or_select_closures() {
...
function add_to_cart_buy_or_select_closures_listing() {
...
function wpv_woo_display_tabs_func() {
	...
	global $woocommerce, $WPV_templates;
	//Remove this filter, run only once -prevent endless loop due to WP core apply_filters on the_content hook
